...
class TestMemoize(unittest.TestCase):
    """
    Defines test cases for the memoize decorator from utils.
    """

    def test_memoize(self) -> None:
        """
        Tests that memoize caches the result of a method after the first
        call, ensuring the underlying method is only executed once.
        """
        class TestClass:
            """A test class to verify memoize behavior."""
            ...
            def a_property(self) -> int:
                """Calls a_method, demonstrating memoization."""
